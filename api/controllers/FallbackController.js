...
var fallbackHome = function (req, res, next, force, showLegacyToast) {
  ...
  Content.find({name:'about'}).exec(function found(err, results) {
    ...
    Content.find({name:'goals'}).exec(function found(err, results) {
      ...
      return ThemeService.view(req.session.uri.host, 'views/fallback/home/content.jade', res, {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, about: about, goals: goals, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Startseite' });
    });
  });
}
...
var fallbackMembers = function (req, res, next, force, showLegacyToast) {
  ...
  Member.find().exec(function found(err, results) {
    ...
    return ThemeService.view(req.session.uri.host, 'views/fallback/members/content.jade', res, {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, members: members, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Vorstand / Beirat' });
  });
}
...
var fallbackEvents = function (req, res, next, force, showLegacyToast) {
  ...
  Timeline.find().exec(function found(err, results) {
    ...
    return ThemeService.view(req.session.uri.host, 'views/fallback/events/timeline.jade', res,  {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, events: events, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Veranstaltungen' });
  });
}
...
var fallbackGallery = function (req, res, next, force, showLegacyToast) {
  ...
  Gallery.find().exec(function found(err, results) {
    images = results;
    return ThemeService.view(req.session.uri.host, 'views/fallback/gallery/content.jade', res, {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, images: images, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Galerie' });
  });
}
...
var fallbackApplication = function (req, res, next, force, showLegacyToast) {
  ...
  Content.find({name:'application'}).exec(function found(err, results) {
    ...
    return ThemeService.view(req.session.uri.host, 'views/fallback/application/content.jade', res, {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, application: application, member: member, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Aufnahmeantrag' });
  });
}
...
var fallbackLinks = function (req, res, next, force, showLegacyToast) {
  ...
  Content.find({name:'links'}).exec(function found(err, results) {
    ...
    return ThemeService.view(req.session.uri.host, 'views/fallback/links/content.jade', res, {showLegacyToast: showLegacyToast, force: force, host: req.host, url: req.path, links: links, useragent: req.useragent, title: 'Nautischer Verein Cuxhaven e.V. - Links' });
  });
}
...
var fallbackImprint = function (req, res, next, force, showLegacyToast) {
  ...
  var view = function (req, host, url, form, useragent, emailIsSend) {
    Content.find({name:'imprint'}).exec(function found(err, results) {
      ...
      return ThemeService.view(req.session.uri.host, 'views/fallback/imprint/content.jade', res, {showLegacyToast: showLegacyToast, force: force, emailIsSend: emailIsSend, host: host, url: url, imprint: imprint, form: form, useragent: useragent, title: 'Nautischer Verein Cuxhaven e.V. - Impressum' });
    });
  }
